package com.xiaomo.route.inter.aop;

import com.alibaba.fastjson.JSON;
import com.xiaomo.route.inter.exception.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.xiaomo.route.inter.controller..*.*(..))")
    ...
    public Object aroundApi(ProceedingJoinPoint point) throws Throwable {
        ...
        logger.info("日志统一打印 ↑ ↑ ↑ ↑ ↑ ↑ {}.{}() end ↑ ↑ ↑ ↑ ↑ ↑,响应时间:{}毫秒,响应内容:\n{}",
                point.getSignature().getDeclaringTypeName(), point.getSignature().getName(),
                interval.toDurationMillis(), argsToString(response));
        return response;
    }
