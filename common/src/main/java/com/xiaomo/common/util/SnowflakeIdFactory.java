...
public class SnowflakeIdFactory {
    ...
    public synchronized long nextId() {
       ...
       /* if (currentTimestamp < lastTimestamp) {
        ...
        System.out.println("=========="+(timestamp | dataCenterId | workerId | sequence));
    ...
    public static Set<Long> testProductIdByMoreThread(int dataCenterId, int workerId, int n) throws InterruptedException {
    ...
    public static void main(String[] args) {
         ...
         *   结论: 验证通过,没有重复. */
        try {
            Set<Long> setAll = testProductIdByMoreThread(1, 2, 2);//单机测试此场景,性能损失至少折半!
            for (Long id : setAll) {
